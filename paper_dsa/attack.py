...
1.    n = 200;
2.    q,A,target,sol,nr,M_n= equivalences_dsa(n,159,157,'',3) # an instance of DSA-system
...
The improved heuristic attack :
    ...
    beta  = 159 # the bit length of the derivative ephemeral keys
    n = 206     # number of signatures
