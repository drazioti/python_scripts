We provide an implemementation and an attack of Naccache-Stern knapsack cryptosystem
...
The code was used in the paper: Birthday type attacks to the Naccache-Stern Knapsack cryptosystem,to appear in : IPL,
