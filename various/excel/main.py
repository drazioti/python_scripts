...
SKIPROWS = 1 # depends on the format of the file : input path (the header does not count)
NROWS    = 394 # TODO : compute this. Is the real number of number of grades minus 1
